            ...
            if cnt == 0:
                ...
                for i in range(1, 4):
                    ...
                    if id_ == S.HEAP_CNT_ID:
                        ...
                        self.assertEqual(mode, S.IMMEDIATEADDR)
                        self.assertEqual(S.unpack(S.DEFAULT_FMT, raw_val)[0][0],
...
class TestDescriptor(unittest.TestCase):
    def setUp(self):
        self.d = S.Descriptor(id=33000, name='varname', description='Description')

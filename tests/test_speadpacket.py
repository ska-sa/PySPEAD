...
class TestSpeadPacket(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        pkt.items = [(S.IMMEDIATEADDR, S.HEAP_CNT_ID, 5), (S.IMMEDIATEADDR, S.PAYLOAD_LEN_ID, 8),
                     (S.IMMEDIATEADDR, S.PAYLOAD_OFF_ID, 8)]
        ...
        self.assertEqual(pkt.items, ((S.IMMEDIATEADDR, S.HEAP_CNT_ID, 5), (S.IMMEDIATEADDR, S.PAYLOAD_LEN_ID, 8),
                                     (S.IMMEDIATEADDR, S.PAYLOAD_OFF_ID, 8)))
    ...
    def test_unpack_piecewise(self):
        ...
        self.assertEqual(self.pkt.items, (
            (S.IMMEDIATEADDR, S.HEAP_CNT_ID, 3), (S.DIRECTADDR, 0x3333, 0), (S.IMMEDIATEADDR, S.PAYLOAD_LEN_ID, 8)))
